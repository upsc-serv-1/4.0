Now the SkiaCanvas with gesture-handler + paper backgrounds + stroke selection:
Action: file_editor create /tmp/upsc-repo/src/components/hardnotes/SkiaCanvas.tsx --file-text "/**
...
"
Observation: Overwrite successful: /tmp/upsc-repo/src/components/hardnotes/SkiaCanvas.tsx
