...
- [x] **Task 4: Implement Smart Append** (auto-numbering, separator, "Undo Save" toast)
...
- [x] Implement optional separator divider insertion
- [x] Implement auto-continue numbering
- [x] Implement timestamp marking for imports
- [x] Implement conversion of quiz text selections to element list
- [x] Implement "Undo Save" popup toast immediately after appending text
- [x] Implement block-level metadata tracking ("Added by quiz import" visual badge)
...
- [x] Implement enhanced export panel sheet
