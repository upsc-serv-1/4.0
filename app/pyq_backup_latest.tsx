...
type HubKey = 'overview' | 'heatmaps' | 'focused' | 'pilot';
  ...
  const renderSubjectYearHeatmap = () => (
    <View style={styles.blockGap}>
      ...
      <StickyHeatmapTable
        ...
        onCellPress={(subject, year) => handleHeatmapPress(subject, { subject }, year)}
        onRowPress={(subject) => handleHeatmapPress(subject, { subject })}
      />
    </View>
  );
    ...
    <View style={[styles.container, { backgroundColor: isEmbedded ? 'transparent' : colors.bg }]}>
      ...
      <View style={[styles.tabBar, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        {[
          ...
          { key: 'pilot', label: 'Pilot', icon: Target },
        ].map(item => {
