  ...
  return (
    <PageWrapper>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <TouchableOpacity
          testID="master-download-center-card"
          onPress={() => router.push('/resources_master')}
          style={{
            backgroundColor: '#1d4ed8',
            padding: 18, borderRadius: 14, marginBottom: 14, marginHorizontal: 20, marginTop: 10
          }}
        >
          <Text style={{ color: '#fff', fontSize: 18, fontWeight: '700' }}>
            Master Download Center
          </Text>
          <Text style={{ color: '#dbeafe', marginTop: 4 }}>
            Export Questions, Flashcards, Notes & Tags as premium PDFs
          </Text>
        </TouchableOpacity>
