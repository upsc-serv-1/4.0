...
def clean_md(text):
    if not text:
        return ''
    # Protect numbered/lettered lists from markdown <ol>/<ul> swallowing
...
print(f'PDF successfully generated with full list number protection and headers at: {pdf_output}')
