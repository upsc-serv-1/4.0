...
def import_all():
    ...
    print(f"Found {len(all_files)} JSON files across subdirectories.")
    ...
    for idx, file_path in enumerate(all_files):
        ...
        print(f"\n--- Processing [{idx+1}/{len(all_files)}]: {filename} ---")
        ...
        try:
            ...
            for q in data.get("questions", []):
                ...
                # NCERT detection
                is_ncert = q.get("is_ncert") or q.get("isNcert") or ei.get("is_ncert") or "NCERT" in (q.get("source_attribution_label") or "")
                ...
                row = {
                    ...
                    "exam": q.get("exam") or ei.get("exam"),
