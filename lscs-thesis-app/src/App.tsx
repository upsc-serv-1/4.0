...
import { Sun, Moon, BarChart3, Database, AlertCircle, Clipboard, Check, Edit3, Save, X, FileText } from 'lucide-react';
...
export default function App() {
  ...
  const [workspaceView, setWorkspaceView] = useState<'dashboard' | 'entry' | 'reports'>('dashboard');
