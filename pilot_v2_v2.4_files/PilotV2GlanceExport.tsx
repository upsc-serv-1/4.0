 ...
 *      remapStrokeForExport triggers ΓÇö strokes get raw relativeΓåÆabsolute
...
const BLOCK_TO_HTML = (b: PilotV2Block, fs: number): string => {
  ...
  switch (b.type) {
    ...
    case 'bullet':
      return `<div style="display:flex;flex-direction:row;gap:8px;margin:4px 0;"><span style="font-size:${fs}pt;line-height:${fs * 1.55}pt;">ΓÇó</span><span style="${baseFont}${bold}${italic}${underline}">${text}</span></div>`;
    case 'numbered':
