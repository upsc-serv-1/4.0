...
export function PilotV2NoteList() {
  ...
  const filtered = useMemo(() => {
    ...
    // Step 8 ΓÇö search across note titles AND block contents.
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Alert.alert('View Options', undefined, [
                    {
                      text: viewMode === 'list' ? 'Γ£ô View as List' : 'View as List',
                      onPress: () => setViewMode('list'),
                    },
                    {
                      text: viewMode === 'grid' ? 'Γ£ô View as Grid' : 'View as Grid',
        ...
        <View style={styles.rmBackdrop}>
          ...
          <View style={[styles.rmCard, { backgroundColor: colors.surface, borderColor: colors.border }]} testID="pilot-v2-rename-modal">
            ...
            <View style={{ flexDirection: 'row', gap: 8, marginTop: 12 }}>
              ...
              >
                <Text style={{ color: '#fff', fontWeight: '700' }}>{savingRename ? 'SavingΓÇª' : 'Save'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
