/**
 * Pilot V2 ΓÇö Sidebar (Home mode)
 *
 * Faithful port of the KM app `Sidebar` (mode === 'home'). Renders:
 *   ΓÇó Brand header
 *   ΓÇó Quick-nav (Home / Pinned / Recent / Shared / Trash)
 *   ΓÇó Subjects list with coloured icon tile and chevron-right hover
 *   ΓÇó New Subject CTA
 *   ΓÇó Settings footer
 *
          ...
          <View style={[styles.nsCard, { backgroundColor: colors.surface, borderColor: colors.border }]} testID="pilot-v2-new-subject-modal">
            ...
            <View style={{ flexDirection: 'row', gap: 8, marginTop: 12 }}>
              ...
              >
                ...
                <Text style={{ color: '#fff', fontWeight: '700' }}>{creating ? 'CreatingΓÇª' : 'Create'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
