/**
 * PilotV2UndoSaveToast ΓÇö temporary "Saved ┬╖ Undo" snackbar.
 *
...
/**
 * Stateful toast view ΓÇö animated entrance / exit and auto-dismiss after
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.undoText}>{undoing ? 'UndoingΓÇª' : 'Undo'}</Text>
      </TouchableOpacity>
...
/**
 * Imperative hook ΓÇö call `show(handle, message?)` after a smart append; the
