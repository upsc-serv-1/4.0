/**
 * pilotV2LocalStore ΓÇö Notability-style local-first cache
 * -------------------------------------------------------
...
export const PilotV2LocalStore = {
  ...
  /** Last 5 saves of a note ΓÇö for "restore previous version" UI. */
  ...
  /** All cached note IDs ΓÇö used by crash-recovery hydration. */
  listAll(): string[] {
    return readIndex();
  },

  /** Backend identifier ("MMKV" or "AsyncStorage") ΓÇö useful in dev banners. */
  backendName(): string {
