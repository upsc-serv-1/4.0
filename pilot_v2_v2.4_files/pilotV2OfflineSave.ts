/**
 * pilotV2OfflineSave ΓÇö local-first save wrapper for Pilot V2.
 * -----------------------------------------------------------
...
export async function savePilotV2NoteOfflineFirst(
  ...
  // 1. Always write locally first ΓÇö this is what makes the editor crash-safe.
  ...
  try {
    ...
    // intentional swallow ΓÇö sync queue will retry
...
export function hydratePilotV2Note(
  ...
  // server has the latest ΓåÆ also refresh local copy so subsequent reads are
