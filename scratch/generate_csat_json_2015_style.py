...
mapping_path = r"C:\Users\Dr. Yogesh\Downloads\Qwen_json_20260725_4bvuoipmw_backup_mapping.json" # read from backup mapping
output_path = r"C:\Users\Dr. Yogesh\Downloads\Qwen_json_20260725_4bvuoipmw.json"

if not os.path.exists(mapping_path):
    # Fallback to current mapping path if backup doesn't exist
...
for idx, block in enumerate(blocks):
    ...
    # Formatting as per 2015 CSAT Style:
    # 1. statementLines starts with ""
    # 2. Split full_question_text by \n and keep all lines (including empty ones)
    statement_lines = [""] + full_question_text.split("\n")
    
    # 3. questionText is full_question_text (which has newlines \n)
...
print(f"\n[SUCCESS] Formatted CSAT 2026 JSON (2015 Style) written to: {output_path}")
