...
def build_md_from_json(json_path, md_path, paper_title):
    ...
    print(f"Rebuilt {os.path.basename(md_path)} -> {os.path.getsize(md_path)} bytes ({len(questions)} questions)")

def main():
    build_md_from_json(J1_PATH, MD1_PATH, "Anthropology Paper 1 PYQs (2020-2025)")
    build_md_from_json(J2_PATH, MD2_PATH, "Anthropology Paper 2 PYQs (2020-2025)")
