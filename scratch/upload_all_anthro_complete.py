...
dir_path = r"C:\Users\Dr. Yogesh\Videos\APP FOLDER - V1 - Copy\app\frontend-noji-2.6.2\3\pilot pro 10.2\mains json files"

target_files = [
    os.path.join(dir_path, "mains_anthro1_new_consolidated.json"),
    os.path.join(dir_path, "mains_anthro2_new_consolidated.json"),
    os.path.join(dir_path, "mains_anthro1_pre2012.json"),
    os.path.join(dir_path, "mains_anthro2_pre2012.json")
]
...
def main():
    ...
    for filepath in target_files:
        ...
        paper_name = data.get("paper", "Optional")
        ...
        for q in questions:
            ...
            subject_val = q.get("subject", "Anthropology")
    ...
    print(f"\nTotal prepared across all 4 files: {len(all_questions)} questions and {len(all_answers)} model answers.")
    ...
    print("\n[COMPLETE] All Anthropology questions (1,827 total) & answers (317 total) are now published in Supabase!")
