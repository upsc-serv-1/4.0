...
json_file = r'C:\Users\Dr. Yogesh\Downloads\Qwen_json_20260725_4bvuoipmw.json'
...
test_id = paper_data.get('id', 'upsc-cse-pyq-2026-gs2')

test_payload = {
    'id': test_id,
    'title': paper_data.get('title', '2026- Prelims - CSAT Paper 2 - UPSC'),
    ...
    'level': paper_data.get('level', 'CSAT'),
...
print(f"\n[SUCCESS] ALL DONE! Successfully sent 2026 UPSC CSAT Paper ({test_id}) with {uploaded_q_count} questions to Supabase!")
