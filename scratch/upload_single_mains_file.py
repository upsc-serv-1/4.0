...
filepath = r"C:\Users\Dr. Yogesh\Videos\APP FOLDER - V1 - Copy\app\frontend-noji-2.6.2\3\pilot pro 10.2\mains json files\mains_gs4_consolidated.json"
...
def main():
    ...
    print(f"Prepared {len(all_questions)} questions and {len(all_answers)} model answers for upload.")
    
    if all_questions:
        print("Uploading questions to public.mains_questions...")
        upload_batch("mains_questions", all_questions)
        
    if all_answers:
        print("Uploading answers to public.mains_answers...")
