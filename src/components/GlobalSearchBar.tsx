...
export const GlobalSearchBar: React.FC<GlobalSearchBarProps> = ({
      ...
      if (query.trim().length > 1) {
        ...
        try {
          ...
          if (ncertFilter === 'NCERT Only') {
            localResults = localResults.filter((r: any) => r.is_ncert === true);
  ...
  }, [query, searchFields, selectedSubjects, selectedSections, selectedMicrotopics, hideDropdown]);
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.searchBar, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <TextInput
          ...
          value={query}
          onFocus={() => {
            if (query.length > 1 && !hideDropdown) setIsDropdownVisible(true);
          }}
          onChangeText={(t) => {
            setQuery(t);
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={[styles.modalContent, { backgroundColor: colors.surface }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.modalScroll}>
              ...
              <FilterStrip title="Curriculum" items={['NCERT Only', 'Non-NCERT']} selected={ncertFilter} onSelect={setNcertFilter} colors={colors} />
            </ScrollView>
