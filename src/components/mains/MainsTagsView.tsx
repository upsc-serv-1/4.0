...
export default function MainsTagsView({
  ...
  onOpenDetailed,
  onOpenQuestionBank,
  valueAddItems = STABLE_EMPTY_ARRAY,
  valueAddTags = STABLE_EMPTY_OBJECT,
  onToggleValueAddTag,
  onCreateTag,
  userTags = STABLE_EMPTY_ARRAY,
  questions = STABLE_EMPTY_ARRAY,
  vaFavorites = STABLE_EMPTY_SET,
  onToggleVaFavorite,
}: {
  colors: any;
  isTablet: boolean;
