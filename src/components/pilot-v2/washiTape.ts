/**
 * Pilot V2 — Active Recall Washi-Tape System (Item 11)
 * ----------------------------------------------------
...
export interface PilotV2WashiTape {
  ...
  /** Persisted reveal state — when true, content under the tape is shown
...
/** Type augmentation — add `washiTapes` to PilotV2NoteContent. */
